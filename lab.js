...
if (temperature >= 80 && rain === true) {
  ...
  console.log("Wear a t-shirt, shorts, and flip-flops")
} else if (temperature > 60 && temperature < 80 && rain === false) {
  console.log("Wear a long-sleeve and pants")
} else {
...
// Once you have logged the countdown, make sure you decrement z by 1. If your code is running 
